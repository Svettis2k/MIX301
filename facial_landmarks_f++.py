...
for face in json["faces"]:
    ...
    f_image = util.draw_points_copy(image, lu.dict_to_coordinates(landmark_dict))

    util.show_image("Facial landmarks: Face++", f_image)

    print(calculate_skin_mean(f_image, landmark_dict))
